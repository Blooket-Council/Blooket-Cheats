...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/05Konz/Blooket-Cheats/main/autoupdate/timestamps/gold/resetAllGold.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1707790074458 || iframe.contentWindow.confirm(error)) cheat();
    }
