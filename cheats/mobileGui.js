...
(() => {
    const cheat = (async () => {
        ...
        footer.innerHTML = (`<span><a target="blank" href="https://discord.gg/jHjGrrdXP6">Discord</a><br/><a target="blank" href="https://github.com/05Konz2/Blooket-Cheats">GitHub - 05Konz</a></span>`);
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/05Konz2/Blooket-Cheats/main/autoupdate/timestamps/mobileGui.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1708356622144 || iframe.contentWindow.confirm(error)) cheat();
    }
