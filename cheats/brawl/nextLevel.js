...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/05Konz2/Blooket-Cheats/main/autoupdate/timestamps/brawl/nextLevel.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1708356621723 || iframe.contentWindow.confirm(error)) cheat();
    }
