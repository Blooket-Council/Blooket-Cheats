...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/brawl/nextLevel.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        let _, time = 1730670505798, error = "There was an error checking for script updates. Run cheat anyway?";
        try {
            [_, time, error] = decode.match(/LastUpdated: (.+?); ErrorMessage: "((.|\n)+?)"/);
        } catch (e) {}
        if (parseInt(time) <= 1730670505798 || iframe.contentWindow.confirm(error)) cheat();
    }
