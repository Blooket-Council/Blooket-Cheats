...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/05Konz2/Blooket-Cheats/main/autoupdate/timestamps/tower-defense/setRound.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1708356622219 || iframe.contentWindow.confirm(error)) cheat();
    }
