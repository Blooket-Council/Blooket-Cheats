...
(() => {
    ...
    const cheat = (async () => {
        ...
        function GUI() {
            ...
            const variables = makeElement(
                "style",
                null,
                `:root {--backgroundColor: ${settings.data?.theme?.backgroundColor || "rgb(11, 194, 207)"};--infoColor: ${settings.data?.theme?.infoColor || "#9a49aa"};--cheatList: ${settings.data?.theme?.cheatList || "#9a49aa"};--defaultButton: ${
                    settings.data?.theme?.defaultButton || "#9a49aa"
                };--disabledButton: ${settings.data?.theme?.disabledButton || "#A02626"};--enabledButton: ${settings.data?.theme?.enabledButton || "#47A547"};--textColor: ${settings.data?.theme?.textColor || "white"};--inputColor: ${
                    settings.data?.theme?.inputColor || "#7a039d"
                };--contentBackground: ${settings.data?.theme?.contentBackground || "rgb(64, 17, 95)"};}`
            );
            const { current: gamemodes } = useRef(["global", "gold", "hack", "fish", "pirate", "defense2", "brawl", "dino", "royale", "defense", "cafe", "factory", "racing", "rush", "classic", "tower", "kingdom", "toy", "flappy", "settings"]);
            ...
            return makeElement(
                ...
                makeElement("style", null, "@import url('https://fonts.googleapis.com/css?family=Titan+One');\n@import url('https://fonts.googleapis.com/css?family=Nunito');" + styles.css),
                variables,
                makeElement(
                    "div",
                    {
                            ...
                            makeElement(
                                ...
                                (({ ctrl: ctrlHide, shift: shiftHide, alt: altHide, key: keyHide } = { ctrl: true, key: "e" }, { ctrl: ctrlClose, shift: shiftClose, alt: altClose, key: keyClose } = { ctrl: true, key: "x" }) => {
                                    return makeElement(
                                        ...
                                        makeElement("br", null),
                                        makeElement(AntiBen, null, "Click and drag here")
                                    );
                                })(
                                    settings.data.hide || {
                                        ctrl: true,
                            ...
                            makeElement(
                                ...
                                makeElement(
                                    AntiBen,
                                    {
                                        ...
                                        href: "https://github.com/Blooket-Council/Blooket-Cheats",
                                    },
                                    "GitHub - 05Konzz"
                                )
                            ),
                            ...
                            makeElement(
                                ...
                                makeElement(
                                    ...
                                    makeElement(
                                        ...
                                        Cheats[currentMode].element ||
                                            (Cheats[currentMode].element = makeElement(
                                                React.Fragment,
                                                null,
                                                makeElement(
                                                    "div",
                                                    ...
                                                    makeElement(AntiBen, null, Cheats[currentMode].name, " Cheats")
                                                ),
                                                Cheats[currentMode].cheats.map(
                                                    (cheat) =>
                                                        cheat.element ||
                                                        makeElement(ScriptButton, {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/reactGui.png?" + Date.now();
