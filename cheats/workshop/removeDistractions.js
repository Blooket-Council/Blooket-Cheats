...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/05Konz2/Blooket-Cheats/main/autoupdate/timestamps/workshop/removeDistractions.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1708356622282 || iframe.contentWindow.confirm(error)) cheat();
    }
