...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/05Konz2/Blooket-Cheats/main/autoupdate/timestamps/global/intervals/subtleHighlightAnswers.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1708356622003 || iframe.contentWindow.confirm(error)) cheat();
    }
